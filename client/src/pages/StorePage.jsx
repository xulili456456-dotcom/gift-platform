...
const PRODUCTS = [
  ...
  { img:'/products/28.jpg', name:'Nilight 4" 60W LED Light Bar 2PCS - Flood Spot Combo Work Driving Lamp with Wiring Harness', price:26.99, sold:1300, cat:'汽车', rating:4.6, reviews:7602, specs:{'功率':'60W x2','尺in':'4"','类型':'Flood+Spot Combo','防水':'IP65','附件':'12ftWiring Harness'}, desc:"" },
  ...
  { img:'/products/30.jpg', name:'Nilight 6" Oval Red LED Tail Lights 2PCS - Surface Mount Stop Brake Turn Trailer Lights IP65', price:16.20, sold:2200, cat:'汽车', rating:4.7, reviews:6869, specs:{'尺in':'6" Oval','功能':'Brake/Turn/Tail Light','防水':'IP65','电压':'12V','功率':'18W','适用':'RV/Truck/Trailer/Jeep'}, desc:"" },
  { img:'/products/31.jpg', name:'GM Genuine Parts 12736813 Starter - OEM Replacement for Chevrolet Buick GMC Cadillac', price:186.00, sold:25, cat:'汽车', rating:5.0, reviews:20, specs:{'品牌':'GM Genuine Parts','类型':'Starter Motor','适用':'Chevrolet/Buick/GMC/Cadillac','品质':'OEMOEM Replacement','保修':'GM Warranty'}, desc:"" },
  ...
  { img:'/products/35.jpg', name:'Nilight ZH408 52" Curved Triple Row LED Light Bar 783W 78000LM - Spot Flood Combo with Wiring Kit', price:139.99, sold:1100, cat:'汽车', rating:4.6, reviews:7602, specs:{'尺in':'52" Curved','功率':'783W','亮度':'78000LM','防水':'IP67','材质':'Aluminum Alloy','附件':'12AWG Harness + Switch'}, desc:"" },
  ...
  { img:'/products/42.jpg', name:'Chemical Guys 14-Pc Car Wash Kit - Foam Blaster, Bucket, Soaps, Waxes, Detailing Set', price:124.99, sold:3200, cat:'汽车', rating:4.6, reviews:8983, specs:{'件数':'14-Piece Set','包含':'Foam Cannon/Bucket/Towels/Wax/Cleaners','连接':'Standard Garden Hose','肥皂':'Honeydew Snow Foam','清洁':'Wheels/Glass/Interior'}, desc:"" },
  { img:'/products/43.jpg', name:'Schumacher DSR125 4-Bank Battery Charger/Maintainer - 6V/12V Auto, Smart Amperage Control', price:267.65, sold:55, cat:'汽车', rating:4.4, reviews:535, specs:{'通道':'4 Independent Banks','电压':'6V/12V Auto','保护':'Overcharge / Short Circuit','适用':'Car/Truck/SUV','重量':'12lbs','输出':'12V DC'}, desc:"" },
  ...
  { img:'/products/52.jpg', name:'Tyger Auto T3X Soft Tri-Fold Truck Bed Tonneau Cover - Compatible with 2024-2026 Toyota Tacoma 5ft Bed', price:329.00, sold:5, cat:'汽车', rating:4.0, reviews:1, specs:{'类型':'Tri-Fold Soft Cover','材质':'Aluminum Alloy + PVC Fabric','适用':'2024-2026 Tacoma 5ft Bed','锁定':'Clamp-On','防水':'PVC Coating'}, desc:"" },
  ...
  { img:'/products/58.jpg', name:'Rivian NACS DC Adapter - NACS to CCS for Electric Vehicles', price:210.0, sold:456, cat:'汽车', rating:4.3, reviews:174, specs:{}, desc:"" },
  ...
  { img:'/products/61.jpg', name:'Rivian License Plate Frame - Matte Black, Universal Fit', price:55.0, sold:477, cat:'汽车', rating:4.3, reviews:183, specs:{}, desc:"" },
  ...
  { img:'/products/63.jpg', name:'New 2026 Hyundai Venue SEL - Two-Tone Roof, Compact SUV', price:24995.0, sold:491, cat:'汽车', rating:4.3, reviews:189, specs:{}, desc:"" },
  ...
  { img:'/products/65.jpg', name:'New 2026 Hyundai IONIQ 5 SEL - Electric SUV, AWD', price:46085.0, sold:505, cat:'汽车', rating:4.3, reviews:195, specs:{}, desc:"" },
  { img:'/products/66.jpg', name:'New 2026 Hyundai Sonata SEL Sport - Serenity White, AWD, 191hp', price:33060.0, sold:512, cat:'汽车', rating:4.3, reviews:198, specs:{}, desc:"" },
  ...
  { img:'/products/69.jpg', name:'New 2026 Hyundai Santa Fe Hybrid Limited - Serenity White, AWD, 231hp', price:51240.0, sold:533, cat:'汽车', rating:4.3, reviews:207, specs:{}, desc:"" },
  { img:'/products/70.jpg', name:'New 2026 Hyundai Palisade HEV Calligraphy - Robust Emerald, AWD, 329hp', price:61125.0, sold:540, cat:'汽车', rating:4.3, reviews:210, specs:{}, desc:"" },
  ...
  { img:'/products/73.jpg', name:'New 2026 Hyundai Santa Cruz XRT - Canyon Red, Crew Cab, AWD, 281hp', price:44325.0, sold:561, cat:'汽车', rating:4.3, reviews:219, specs:{}, desc:"" },
  ...
  { img:'/products/77.jpg', name:'Canfanni 4-Piece Snack Box Containers Set - 4 Compartment, Stackable, BPA-Free', price:8.96, sold:589, cat:'家居', rating:4.3, reviews:231, specs:{}, desc:"" },
  ...
  { img:'/products/81.jpg', name:'Pure Future Air-Tight Snackle Box - Divided Serving Tray with Lid & Handle, Clear', price:23.99, sold:617, cat:'家居', rating:4.3, reviews:243, specs:{}, desc:"" },
  ...
  { img:'/products/94.jpg', name:'MotherCould Snack Box Containers Set of 2 - 8 Adjustable Compartments, BPA-Free, Blue', price:19.95, sold:500, cat:'家居', rating:4.3, reviews:188, specs:{}, desc:"" },
  ...
  { img:'/products/99.jpg', name:'Dipoo 60-Set Deli Containers with Lids - 32/16/8oz, Leak-Proof BPA Free, Microwave Safe', price:22.78, sold:525, cat:'家居', rating:4.3, reviews:198, specs:{}, desc:"" },
  ...
  { img:'/products/102.jpg', name:'Ziploc XL Sandwich and Snack Bags 90 Count - Double Zipper, Easy Open Close', price:10.69, sold:540, cat:'家居', rating:4.3, reviews:204, specs:{}, desc:"" },
  ...
  { img:'/products/160.jpg', name:'NASHALYLY Womens Chiffon Elastic High Waist Pleated A-Line Flared Maxi Skirt', price:40.0, sold:604, cat:'女装', rating:4.3, reviews:146, specs:{}, desc:"" },
  ...
  { img:'/products/220.jpg', name:'HERBATOMIA Pleated A-line Midi Skirt Elastic Waist Button Front Casual Flared Blue', price:37.0, sold:656, cat:'女装', rating:4.3, reviews:159, specs:{}, desc:"" },
  { img:'/products/159.jpg', name:'Rip Van Wafels Dutch Caramel & Vanilla Stroopwafels 12-Count - Low Sugar Keto', price:14.97, sold:660, cat:'食品', rating:4.3, reviews:160, specs:{}, desc:"" },
  { img:'/products/162.jpg', name:'Cicy Bell Womens Casual Blazers Open Front Long Sleeve Work Office Jacket - Dark Green', price:48.0, sold:664, cat:'女装', rating:4.3, reviews:161, specs:{}, desc:"" },
  { img:'/products/161.jpg', name:'Ferrero Collection Premium Assorted Chocolates 48-Count - Hazelnut, Dark, Coconut', price:39.98, sold:668, cat:'食品', rating:4.3, reviews:162, specs:{}, desc:"" },
  ...
  { img:'/products/169.jpg', name:'oxiuly Womens Vintage Patchwork Pockets Puffy Swing Casual Party Dress - Gird-bk', price:43.0, sold:692, cat:'女装', rating:4.3, reviews:168, specs:{}, desc:"" },
  { img:'/products/168.jpg', name:'OTOKI Jin Ramen Mild Korean Instant Ramen 18-Pack - 13-Hour Beef Bone Broth', price:27.89, sold:696, cat:'食品', rating:4.3, reviews:169, specs:{}, desc:"" },
  ...
  { img:'/products/180.jpg', name:'Tankaneo Womens Short Sleeve Cropped T-Shirt Summer Rolled Dolman Sleeve Crop Top', price:24.0, sold:736, cat:'女装', rating:4.3, reviews:179, specs:{}, desc:"" },
  { img:'/products/179.jpg', name:'Hero Seeded Bread 4 Loaves - 1g Net Carb Keto Friendly 60 Calories per Slice', price:55.97, sold:740, cat:'食品', rating:4.3, reviews:180, specs:{}, desc:"" },
  ...
  { img:'/products/188.jpg', name:'IUT Solid Push Up Board 15-in-1 - Multi-Functional Pushup Stands System', price:19.99, sold:594, cat:'运动', rating:4.3, reviews:188, specs:{}, desc:"" },
  ...
  { img:'/products/191.jpg', name:'YOLEO Adjustable Weight Bench - ASTM-Certified 827lbs, 84 Positions, Foldable', price:75.49, sold:603, cat:'运动', rating:4.3, reviews:191, specs:{}, desc:"" },
  ...
  { img:'/products/194.jpg', name:'HPYGN Resistance Bands Set - Exercise Bands with Handles, Door Anchor, Ankle Straps', price:20.99, sold:612, cat:'运动', rating:4.3, reviews:194, specs:{}, desc:"" },
  ...
  { img:'/products/209.jpg', name:'Bersauji 2026 Upgraded Ab Roller Wheel with Knee Mat & Timer - Automatic Rebound', price:27.99, sold:657, cat:'运动', rating:4.3, reviews:209, specs:{}, desc:"" },
  ...
  { img:'/products/212.jpg', name:'FITGIRL Ankle Strap for Cable Machine - Premium Padding, Glute Workouts', price:7.99, sold:666, cat:'运动', rating:4.3, reviews:212, specs:{}, desc:"" },
  ...
  { img:'/products/146.jpg', name:'Nurri 30g Protein Ultra Filtered Milk Shake 10-Pack - Vanilla, Lactose Free', price:26.88, sold:678, cat:'食品', rating:4.3, reviews:216, specs:{}, desc:"" },
  ...
  { img:'/products/216.jpg', name:'Darigold FIT High Protein Whole Ultra-Filtered Milk 12-Pack - 14oz, Lactose Free', price:31.89, sold:690, cat:'食品', rating:4.3, reviews:220, specs:{}, desc:"" },
