    ...
    <div style={{background:'#f2f2f7',minHeight:'100vh',maxWidth:430,margin:'0 auto',paddingBottom:80}}>
      ...
      <div style={{background:'#0f0f0f',padding:'12px 16px 16px',color:'#fff'}}>
        <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12}}>
          ...
          <a href="/mine/deposit" style={{textDecoration:'none',padding:'10px 20px',background:'#00A86B',color:'#fff',border:'none',borderRadius:10,fontSize:12,fontWeight:700,cursor:'pointer',minWidth:80,minHeight:40,display:'inline-block'}}>+ Deposit</a>
        </div>
